...
[Codepen scope and cascade example](https://codepen.io/astrotim/pen/PoNGmNN?editors=1100).
...
In the absense of a 'local' custom property, the `var()` function will _inherit_ the value from the property in closest _proximity_.
...
[This guy called Mike](https://www.madebymike.com.au/writing/a-strategy-guide-to-css-custom-properties/) has coined a term for an interesting concept based on using CSS Custom Properties: _the logic fold_.
...
- [CodePen collection](https://codepen.io/collection/DoQqpE) from this talk
